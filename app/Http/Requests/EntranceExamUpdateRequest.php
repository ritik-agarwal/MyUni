...
class EntranceExamUpdateRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'name' => 'required|string|max:255|unique:entrance_exams,name,'.$this->entrance_exam->id,
            'description' => 'nullable|string',
            'code' => 'required|string|unique:entrance_exams,code,'.$this->entrance_exam->id,
            'courses' => 'required',
